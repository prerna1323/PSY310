...
expName = 'Discounting_n'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/prernabhandari/Documents/Discounting_n_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/prernabhandari/Documents/discounting .csv'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        text.setText("GDP " + str(reward_today) + " today" + " or" + " GDP " + str(future_reward) + " after " + str(delay) + " days")
