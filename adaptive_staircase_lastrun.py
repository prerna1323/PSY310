...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\prerna\\OneDrive\\Documents\\PSY310\\adaptive_staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        if isinstance(stair, data.TrialHandler2) and thisStair.thisN != stair.thisTrial.thisN:
    ...
    stair.saveAsExcel(filename + '.xlsx', sheetName='stair')
